# HDI_LISTBOXES_Properties_v2 

How do manage listbox properties (4D v18 R4)

Find more information on the [blog post](https://blog.4d.com/list-boxes-setup-movable-rows-or-not-by-code/).
